...
export const MapContext = React.createContext({ lat: -27.498025783712994, lng: 153.04370816437722 });
...
export class Main extends React.Component<MainProps, {}> {
    ...
    render() {
      ...
      return (
        <MapContext.Provider value={{ lat: -27.498025783712994, lng: 153.04370816437722 }}>
          <Map></Map>
